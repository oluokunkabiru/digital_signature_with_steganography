...
class VerificationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $verify = $this->verify($data, file_get_contents($key));
        ...
        $signature = "verification/signature/". $verificationname; 
        ...
        $publicKey = "verification/signature/". $verifypkey;
        Storage::disk('public')->put($publicKey, $key);
        ...
        $verification->save();
         return redirect()->route('voyager.verifications.index')->with('success', 'Verification successfully');
